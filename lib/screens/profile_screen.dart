        ...
        : Scaffold(
            appBar: AppBar(
              ...
              title: Center(
                child: Text(
                  "Profile",
                  style: TextStyle(color: Colors.white,fontFamily: 'Nutino',fontWeight: FontWeight.bold,fontSize: 25),
                ),
              ),
            ),
            body: ListView(
      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            label,
            style: const TextStyle(
                fontSize: 15, fontWeight: FontWeight.w400, color: Colors.grey,fontFamily: 'Nutino'),
          ),
        )
      ],
    );
